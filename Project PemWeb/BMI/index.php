...
<div class="col-md-5 mx-auto mt-5">
  <header class="text-center mb-3"><h2>Form Data Tubuh (BMI)</h2></header>
  ...
  <div class="text-center mt-3">
    <button type="submit" class="btn btn-succes" name="send">submit</button>
  </div>
  </form>
  <div class="text-center mt-3">
    <a href="data-bmipasien.php">Lihat Data</a>
  </div>
</div>
</body>
</html>